...
import { LayoutDashboard, FileText, Zap, Settings, Bell, Search, Menu, LogOut, Users, DollarSign, ShieldCheck, X, RefreshCw, Package, PieChart, KanbanSquare, ScrollText, CreditCard, PlusCircle, Briefcase } from 'lucide-react';

// ... (rest of imports)

// ... (Layout component remains same until NavItems)
...
function NavItem({ to, icon, tooltip }) {
            ...
            <div style={{ display: 'flex', minHeight: '100vh', width: '100vw', background: 'var(--bg-main)', overflow: 'hidden' }}>
                ...
                <div className={`mobile-drawer ${showProfile ? '' : ''}`} style={{
                    ...
                    <nav style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                        ...
                        <NavItemMobile to="/payments" icon={<DollarSign size={20} />} label="Payments" setShow={setShowMobileMenu} />
    ...
    return (
            <>
                ...
                <NavItem to="/products" icon={<Package size={22} />} tooltip="Products" />
                <NavItem to="/payments" icon={<DollarSign size={22} />} tooltip="Payments" />
                <NavItem to="/masters" icon={<Settings size={22} />} tooltip="Masters Setup" />
